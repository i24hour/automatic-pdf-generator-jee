...
\begin{center}
    {\Large \textbf{DETAILED SOLUTIONS}}
\end{center}
\vspace{0.5cm}

\begin{enumerate}[label=\textbf{Q.\arabic*.}, itemsep=15pt, leftmargin=*]
\BLOCK{ for q in questions }
    \item \textbf{Answer: \VAR{q.answer}}
    \BLOCK{ if q.solution }
    ...
    \textit{Correct option is \VAR{q.answer}.}
    \BLOCK{ endif }
