...
% --- SOLUTIONS SECTION (FIITJEE Style) ---
\BLOCK{ if include_solutions }
\newpage

\begin{center}
    {\Large \textbf{Hints \& Solutions}}\\[0.1cm]
    {\normalsize \VAR{subject}}
\end{center}
\vspace{0.3cm}
...
\small
\BLOCK{ for q in questions }
\noindent\textbf{\VAR{loop.index}.} \hspace{0.3em} \textbf{\VAR{q.answer}}\\[2pt]
\BLOCK{ if q.solution }
\textbf{Sol.} \VAR{q.solution}
\BLOCK{ else }
\textbf{Sol.} Correct option is \VAR{q.answer}.
\BLOCK{ endif }
