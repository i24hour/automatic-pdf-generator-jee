...
\begin{titlepage}
    ...
    {\Large\textcolor{secondary}{AI-Powered Test Paper Generator}}\\[0.3cm]
    ...
    \begin{tikzpicture}
        \node[fill=lightbg, rounded corners=8pt, inner sep=20pt] {
            \begin{tabular}{cl}
                ...
                \faEnvelope & \textbf{Email:} \href{mailto:mentorsmantra@gmail.com}{mentorsmantra@gmail.com} \\[8pt]
...
% -----------------------------------------------------------
\section{Rate Limits \& Promo Codes}
% -----------------------------------------------------------

\subsection{Free Usage Limits}

\begin{itemize}[leftmargin=*]
    \item \textbf{3 test papers} every 6 hours (free tier)
    \item Rate limit resets automatically
\end{itemize}

\subsection{Promo Codes}

Teachers and coaching centers can get additional generations using promo codes:

\begin{enumerate}[leftmargin=*]
    \item Enter your promo code in the \textbf{"Have a promo code?"} section
    \item Click \textbf{"Apply"}
    \item Your generation limit will be increased
\end{enumerate}

\begin{tcolorbox}[notebox]
Contact us at \textbf{mentorsmantra@gmail.com} to get promo codes for your institution.
\end{tcolorbox}
...
\hline
Rate limit reached & Wait for the timer to reset, or use a promo code. \\
\hline
...
\begin{tikzpicture}
    \node[fill=lightbg, rounded corners=10pt, inner sep=20pt] {
        \begin{tabular}{cl}
            ...
            \faEnvelope & \textbf{Email:} \href{mailto:mentorsmantra@gmail.com}{mentorsmantra@gmail.com} \\[10pt]
