...
\hypersetup{
    ...
    pdftitle={User Manual - Test Paper Generator}
}
...
\begin{titlepage}
    ...
    {\Large\textcolor{secondary}{A TestPdf Trained ML model by IITians and NEET Rankers}}\\[0.3cm]
...
\begin{itemize}[leftmargin=*]
    \item \textcolor{accent}{\faCheckCircle} \textbf{Smart Question Generation:} Generate unique, high-quality questions instantly
    \item \textcolor{accent}{\faCheckCircle} \textbf{Multiple Subjects:} Physics, Chemistry, Mathematics, Zoology, and Botany
    ...
    \item \textcolor{accent}{\faCheckCircle} \textbf{Test Portal:} Attempt tests online with a real exam-like interface
\end{itemize}
...
\begin{enumerate}[leftmargin=*]
    \item Visit \textcolor{primary}{\textbf{\href{https://www.infinitest.tech}{www.infinitest.tech}}}
...
\hline
\textbf{\faAtom\ Physics} & \textbf{\faFlask\ Chemistry} & \textbf{\faCalculator\ Maths} & \textbf{\faDna\ Zoology} & \textbf{\faLeaf\ Botany} \\
\hline
\end{tabular}
\end{center}
...
\hline
\textcolor{pink!80!black}{\textbf{NEET}} & Medical entrance exam pattern (Zoology/Botany only have MCQs) \\
\hline
\end{tabularx}
\end{center}
...
\begin{itemize}[leftmargin=*]
    ...
    \item Zoology: "Human Reproduction", "Animal Kingdom"
    \item Botany: "Plant Kingdom", "Photosynthesis"
\end{itemize}
...
\begin{enumerate}[leftmargin=*]
    ...
    \item Wait 30-60 seconds while the system generates questions
...
% -----------------------------------------------------------
\section{Test Portal (CBT Mode)}
% -----------------------------------------------------------

Assess your students with our built-in Computer Based Test (CBT) platform.

\subsection{Features}
\begin{itemize}[leftmargin=*]
    \item \textbf{Real Exam Interface:} Mimics JEE/NEET interface (Palette, Timer, Review options).
    \item \textbf{Instant Results:} Auto-grading with detailed analytics.
    \item \textbf{Device Compatibility:} Works on Laptop, Tablet, and Mobile.
\end{itemize}

\begin{tcolorbox}[notebox]
When you generate a test, a "Start Test" link is also created. Share this link with students to let them attempt the exam online.
\end{tcolorbox}

% -----------------------------------------------------------
\section{Future Roadmap: Video Generator}
% -----------------------------------------------------------

We are actively working on an AI-powered \textbf{Video Generator}.
\begin{itemize}
    \item \textbf{Concept:} Convert text questions into short explainer videos.
    \item \textbf{Status:} \textit{Coming Soon}. This feature will allow visual learning for complex physics and maths problems.
\end{itemize}
...
\begin{itemize}[leftmargin=*]
    \item \textbf{10 test papers} per month (free tier)
    \item Rate limit resets on the 1st of every month
...
\begin{tikzpicture}
    \node[fill=lightbg, rounded corners=10pt, inner sep=20pt] {
        \begin{tabular}{cl}
            ...
            \faPhone & \textbf{Priyanshu:} 9821040290 | \href{mailto:priyanshu@me.iitr.ac.in}{priyanshu@me.iitr.ac.in}
        \end{tabular}
    };
\end{tikzpicture}
\end{center}
